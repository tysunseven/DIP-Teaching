...
def get_expression_points(
    ...
    start_pts, end_pts = transform(expr_id)(landmarks)
...
def on_change_expression(
    ...
    expr_id: FaceExpression = FaceExpression.value_of(expr_str)
...
def main() -> None:
    ...
    points_dict['handle'], points_dict['target'] = get_expression_points(landmarks, FaceExpression.value_of(expression))
    points = points_dict
    print(points)
